...
parser.add_argument('--task_tag', type=str, default=None, help='task tag')
...
to_json(output, output_idx, f'{task_dir}/{task_name}_{args.task_tag}', task_num="1", dataset_name=task_name)

os.makedirs(f'splits/{task_name}_{args.task_tag}', exist_ok=True)

string_to_write = f"{task_name}_{args.task_tag}"

for split in ['train', 'validation', 'test']:
    with open(f'splits/{task_name}_{args.task_tag}/{split}_tasks.txt', 'w', encoding='utf-8') as file:
