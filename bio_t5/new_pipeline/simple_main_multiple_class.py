...
def evaluate_one_file(this_file_path, task, tokenizer, model, batch_size, args):
    ...
    for col_name in col_name_list:
        ...
        try:
            ...
            pass
        # try:
        #     assert len(this_col_smiles) == 152
        # except:
        #     print(this_col_smiles)
        #     print(len(this_col_smiles))
...
def evaluate_one_folder(folder_path, task, tokenizer, model, batch_size, args):
    ...
    for file_name in all_files:
        # if re.findall('_sft_epoch_.*_', file_name) == []:
        #     continue
        print(file_name)
...
def evaluate_one_task(task_folder, task, hparams):
    ...
    for class_folder in all_class_folders:
        ...
        if '_pret' not in class_folder:
            continue
        if not os.path.isdir(this_class_folder):
            continue     
        if class_folder in hparams.skip_class_name:
            continue
...
if __name__ == '__main__':
    ...
    Parser.add_argument('--inference_folder', default='Data/202407/new_inference/8e-7_0.1_512_6', help='inference folder path should include the folder with task name')
