...
def prepare_optimization_inputs():
    ...
    parser.add_argument('method', nargs='?', default='genetic_gfn')
    parser.add_argument('--smi_file', default=None)
    parser.add_argument('--config_default', default='hparams_default.yaml')
    parser.add_argument('--config_tune', default='hparams_tune.yaml')
    parser.add_argument('--pickle_directory', default=None)
    ...
    parser.add_argument('--objectives', type=str, default='qed,sa,drd2,gsk3b,jnk3')
    parser.add_argument('--alpha_vector', default='1,1,1,1,1', type=str)
    ...
    args = parser.parse_args([])  # [] means use default values instead of CLI

    # Post-process arguments
    args.objectives = args.objectives.split(',')
    args.alpha_vector = [float(x) for x in args.alpha_vector.split(',')]
    ...
    return args, config_default, oracle
